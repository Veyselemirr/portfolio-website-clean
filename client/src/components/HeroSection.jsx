...
const HeroSection = () => {
    ...
    return (
        <section className="min-h-screen pt-60 pb-20 bg-gradient-to-b from-[#111827] to-[#0b3d2e] text-white" id="home">
            <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-10">
                <div className="text-center md:text-left md:w-1/2">
                    ...
                    <div className="mt-8 flex space-x-4">
                        <a
                            href="https://github.com/Veyselemirr"
                            target="_blank"
                        ...
                        <a
                            href="https://www.linkedin.com/in/veysel-emir-yurtseven-910622327/"
                            target="_blank"
                            rel="noopener noreferrer"
                ...
                <div className="md:w-1/2 flex justify-center">
                    <div className=" bg-gradient-to-br from-gray-1200 to-[#0b3d2e]  text-green-400 font-mono p-6 rounded-lg shadow-2xl w-[600px] h-[300px] sm:w-[660px] sm:h-[320px] overflow-hidden relative">
                        <p className="text-md mb-2">$ terminal </p>
                        <p className="text-2xl mb-2 ">const developer = "Veysel Emir" </p>
